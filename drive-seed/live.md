...
# Live-State (live.md) — VOLATILER LIVE-STATE
...
- **VO₂max:** {{VO2}}  <!-- Dummy: 35.0 -->
- **Pace@Z2 (temp-normalisiert 18°C):** {{PACE_Z2}}  <!-- Dummy: 9:00/km -->

## PRs (Loot)
- **5k:** {{PR_5K}}  <!-- Dummy: 28:00 -->
- **HM:** {{PR_HM}}  <!-- Dummy: 2:10:00 -->
- **Bench:** {{PR_BENCH}} kg  <!-- Dummy: 60.0 kg -->

## Streaks & Overrides
- **Gym-Streak:** {{GYM_STREAK}}  <!-- Dummy: 0 Wochen -->
- **Aktive Overrides:** {{OVERRIDES}}  <!-- Dummy: keine -->
- **Persona-State:** {{PERSONA_STATE}}  <!-- Dummy: SCHARF -->
